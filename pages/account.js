...
useEffect(() => {
  if (user) {
    const { name: existingName, email: existingEmail, address: existingAddress } = user;
    ...
    <>
      ...
      <Box>
              ...
              !user && (
                ...
                <Button block black onClick={() => router.push("/login")}>Login</Button>
                </>
              )
              }
              <Input
              ...
              <Button black block onClick={e=>handleUpdateUser(e)} >
                Save
              </Button>
              <Button green onClick={handleLogout}>
                Logout
              </Button>
            </Box>
      </Center>
